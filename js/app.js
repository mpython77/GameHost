        ...
        <div class="game-card-body">
          ...
          <div class="game-card-footer">
            ...
            <div class="card-actions">
              ...
              <button class="share-btn" title="Share" data-share-id="${escapeHTML(game.id)}" data-share-name="${escapeHTML(name)}" onclick="event.stopPropagation(); App.shareGame(this.dataset.shareId, this.dataset.shareName)">
